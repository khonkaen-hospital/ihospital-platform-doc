...
**สรุปสถานะ:** 1 active (IoT Data Hub) · 11 draft (รอถอด spec/รอ key) · เจ้าของหลัก **สำนักสุขภาพดิจิทัล (BDH)** สป.สธ. + **กรมการปกครอง (DOPA)** สำหรับ ThaID
...
| 2 | MOPH Provider ID / Health ID | ยืนยันตัวตนบุคลากร+ประชาชน (MOPH), QR/authen code, ออก token+scope | pull | OAuth2 | draft | [→](integrations/moph-provider-id/) |
...
> เลข `#` = ลำดับแนะนำในการลงมือ · `thai-id` ถอด spec ครบแล้ว (พร้อม implement รอแค่ credential) · `moph-alert` มี API doc พร้อมถอด
